...
-- CreateIndex
CREATE UNIQUE INDEX "CardSlot_binderId_pageNumber_slotIndex_key" ON "CardSlot"("binderId", "pageNumber", "slotIndex");
...
-- AddForeignKey
ALTER TABLE "CardSlot" ADD CONSTRAINT "CardSlot_binderId_fkey" FOREIGN KEY ("binderId") REFERENCES "Binder"("id") ON DELETE CASCADE ON UPDATE CASCADE;
